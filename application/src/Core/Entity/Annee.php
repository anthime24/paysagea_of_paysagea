 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="App\Core\Repository\AnneeRepository")
 * @Gedmo\TranslationEntity(class="App\Core\Entity\Translation\Annee")
 */
class Annee extends AbstractPersonalTranslatable implements TranslatableInterface
{
    ...
    /**
     * @ORM\OneToMany(
     *     targetEntity="App\Core\Entity\Translation\Annee",
     *     mappedBy="object",
     ...
     * @var Collection
     *
     * @ORM\OneToMany(targetEntity="App\Core\Entity\EntitePhoto", mappedBy="annee", cascade={"persist"})
     */
    ...
    public function removeEntitePhoto(EntitePhoto $entitePhoto): self
    {
        if ($this->entitePhotos->contains($entitePhoto)) {
            ...
            if ($entitePhoto->getAnnee() === $this) {
                $entitePhoto->setAnnee(null);
            }
        }
