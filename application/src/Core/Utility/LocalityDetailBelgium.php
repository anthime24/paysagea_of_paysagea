...
class LocalityDetailBelgium
{
    /**
     * Largeur des cartes PNG
     */
    public const CARTE_LARGEUR_IMG = 525;

    /**
     * Hauteur des cartes PNG
     */
    public const CARTE_HAUTEUR_IMG = 430;

    public const CARTE_LATITUDE_MIN = 49.30;

    public const CARTE_LATITUDE_MAX = 51.30;

    public const CARTE_LONGITUDE_MIN = 2.33;

    public const CARTE_LONGITUDE_MAX = 6.24;
    ...
    public static function calcul($em, $latitude_point, $longitude_point)
    {
        ...
        /////////////////////////////////////////////
        // Rusticité
        $im = imagecreatefrompng(__DIR__ . '/carte-rusticite-belgique.png');
        $codecouleurhex = LocalityDetailBelgium::codeCouleur($im, $x_carte, $y_carte);
        $rusticite = $em->getRepository(Rusticite::class)->findOneBy(array('codeCouleur' => $codecouleurhex));

        /////////////////////////////////////////////
        // Précipitations estivales
        $im = imagecreatefrompng(__DIR__ . '/carte-precipitation-estivales-belgique.png');
        $codecouleurhex = LocalityDetailBelgium::codeCouleur($im, $x_carte, $y_carte);
        ...
        /////////////////////////////////////////////
        // pH sol
        $im = imagecreatefrompng(__DIR__ . '/carte-ph-belgique.png');
        $codecouleurhex = LocalityDetailBelgium::codeCouleur($im, $x_carte, $y_carte);
